...
echo_and_run cd "/home/pi/catkin_ws/src/mrn_ros_arduino_bridge/ros_arduino_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/pi/catkin_ws/src/mrn_ros_arduino_bridge/ros_arduino_python/setup.py" \
     \
    build --build-base "/home/pi/catkin_ws/build/mrn_ros_arduino_bridge/ros_arduino_python" \
    install \
    --root="${DESTDIR-/}" \

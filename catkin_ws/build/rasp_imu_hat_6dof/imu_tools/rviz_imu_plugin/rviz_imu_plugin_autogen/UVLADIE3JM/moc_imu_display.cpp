...
#include "../../../../../../src/rasp_imu_hat_6dof/imu_tools/rviz_imu_plugin/src/imu_display.h"
...
struct qt_meta_stringdata_rviz__ImuDisplay_t {
    QByteArrayData data[6];
    char stringdata0[59];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_rviz__ImuDisplay_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_rviz__ImuDisplay_t qt_meta_stringdata_rviz__ImuDisplay = {
    {
QT_MOC_LITERAL(0, 0, 16), // "rviz::ImuDisplay"
QT_MOC_LITERAL(1, 17, 9), // "updateTop"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 9), // "updateBox"
QT_MOC_LITERAL(4, 38, 10), // "updateAxes"
QT_MOC_LITERAL(5, 49, 9) // "updateAcc"

    },
    "rviz::ImuDisplay\0updateTop\0\0updateBox\0"
    "updateAxes\0updateAcc"
};
...
const QMetaObject rviz::ImuDisplay::staticMetaObject = {
    { &rviz::MessageFilterDisplay<sensor_msgs::Imu>::staticMetaObject, qt_meta_stringdata_rviz__ImuDisplay.data,
      qt_meta_data_rviz__ImuDisplay,  qt_static_metacall, nullptr, nullptr}
};
...
void *rviz::ImuDisplay::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_rviz__ImuDisplay.stringdata0))
